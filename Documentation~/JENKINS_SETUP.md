...
and Access -> Integrations, put the `.p8` on the Mac, and set:

| Variable | Value |
| --- | --- |
| `UMP_ASC_KEY_PATH` | path to `AuthKey_XXXXXXXX.p8` |
| `UMP_ASC_KEY_ID` | the key id |
| `UMP_ASC_ISSUER_ID` | the issuer id |
